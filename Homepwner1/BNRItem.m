...
//For encoding the items into a data container which comes from NSCoder
/*We're not encoding BNRItem *container itself because that doesn't make sense, that's part of the framework not an instance variable to be copied*/
...
//Doesn't call BNRItem's designated initializer, this is additional help
...
/*Will take a full-sized image, create a smaller representation of it in an offscreen context object, and set the thumbnail pointer to the image produced by the offscreen context*/
